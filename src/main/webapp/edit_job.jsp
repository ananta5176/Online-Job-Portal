			...
			%>				
					...
					<input type="hidden" value="<%=j.getId() %>">	
						<div class="form-group">
							<label>Enter Title</label><input type="text" name="title" required class="form-control" value=<%=j.getTitel() %>>
						</div>
						<div class="form-row">
						...
						<div class="form-group">
								...
								<textarea required rows="6" cols="" name="description" class="form-control"><%=j.getDescription() %></textarea>
							</div>
...
>>>>>>> 8bf6bb47811083a07f58897f0c7fd0473ab6e054
</html>